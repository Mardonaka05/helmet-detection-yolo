...
# ---- Konfiguratsiya ----
WEIGHTS = Path(r"datasets/helmet\runs\helmet_v8l_640\weights\best.pt")
TEST_DIR = Path(r"datasets/helmet\images\test")
OUTPUT_DIR = Path(r"datasets/helmet\runs\predict_test")
N_SAMPLES = 20
