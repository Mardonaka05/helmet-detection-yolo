...
DATASETS_ROOT = Path(r"datasets/helmet\datasets")
...
def check_setup():
    ...
    try:
        ...
        print("    O'rnatish:")
        print(r'      & ".\backend\venv\Scripts\python.exe" -m pip install roboflow')
        sys.exit(1)
...
def main():
    ...
    print()
    print("  Keyingi qadam:")
    print(r'    python "datasets/helmet\scripts\merge_datasets.py"')
